package day04_xpat_cssSelector;
...
public class C02_CssSelector {
    public static void main(String[] args) throws InterruptedException {
      // 1- Gerekli ayarlari yapin
        ...
        System.setProperty("webdriver.chrome.driver","C:\\Users\\90532\\Documents\\selenium dependencies\\drivers\\c");
      ...
      // 5- Sayfa basliginin “Spend less” ifadesi icerdigini test edin
        ...
        if (actualTitle.contains(expectedmetin)){
            ...
            System.out.println("Title testi FAILLED");
